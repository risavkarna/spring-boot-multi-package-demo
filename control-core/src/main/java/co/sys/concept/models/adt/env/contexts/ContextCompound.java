...
import co.sys.concept.models.adt.env.space.Compound;
...
public class ContextCompound<Event, State> extends Context implements Compound<Event, State>{
	...
	@Override
	public co.sys.concept.models.adt.env.space.Compound set(co.sys.concept.models.adt.env.space.Compound<Event, State> compound) {
