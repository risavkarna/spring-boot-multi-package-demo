...
import co.sys.concept.patterns.things.adt.entities.env.space.Compound;
...
public class ContextCompound<Event, State> extends Context implements Compound<Event, State>{
	...
	@Override
	public co.sys.concept.patterns.things.adt.entities.env.space.Compound set(co.sys.concept.patterns.things.adt.entities.env.space.Compound<Event, State> compound) {
